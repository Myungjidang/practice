...
def embedding():
    ...
    for country in tqdm(country_list):
        ...
        try:
            ...
            word_list, word_vector, doc_vector = top2vec_embedding(save_path, country, country_token)
        except ValueError:
            pass
        all_documents = all_documents + country_document
    s_embedding = sbert_embedding(save_path, all_documents, country_list, country_length)
